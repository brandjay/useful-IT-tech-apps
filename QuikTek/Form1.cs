        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            using (FolderBrowserDialog ProfileSnatch = new FolderBrowserDialog())
            {
                ...
                if (result == DialogResult.OK && choice == DialogResult.Yes)
                {
                   ...
                   // check for hidden folder and skip over them
                    ...
                    try
                    {
                        ...
                        security.AddAccessRule(new FileSystemAccessRule(@"yourdomainor-or-pcname if local\User", FileSystemRights.FullControl, AccessControlType.Allow));
